...
if __name__ == "__main__":
    ...
    while 1:
        ...
        while 1:
            ...
            step = -fprimeprime.I @ fprime ###YOUR CODE HERE###
            ...
            while 1:
                ...
                if(pastboundary or (fnew > (f + alpha * k * fprime.T * step))): ###YOUR CODE HERE###):  #put in the check for terminating backtracking line search
                    #if we're not done
        ...
        # numplanes: number of hyperplanes in this problem
